...
\begin{equation*}
    \begin{split}
    \left(\lambda - \lambda^{-1}\right)^2 = &\mu^2\left[  e^{\mathcal{I}(k+l) \Delta x}+e^{\mathcal{I}k \Delta x}-e^{\mathcal{I}l \Delta x}-1 \right. \\
    &\quad+e^{\mathcal{I}k \Delta x}+ e^{\mathcal{I}(k-l) \Delta x}-1-e^{\mathcal{I}l \Delta x} \\
     &\quad-e^{\mathcal{I}l \Delta x}-1+e^{\mathcal{I}(-k+l) \Delta x}+e^{-\mathcal{I}k \Delta x} \\ 
     &\quad-1-e^{-\mathcal{I}l \Delta x}+e^{-\mathcal{I}k \Delta x}+e^{-\mathcal{I}(k+l) \Delta x} \\
     &\quad e^{\mathcal{I}(k+l) \Delta x}+e^{\mathcal{I}l \Delta x}-e^{\mathcal{I}k \Delta x}-1  \\
     &\quad+e^{\mathcal{I}l \Delta x}+ e^{\mathcal{I}(-k+l) \Delta x}-1-e^{\mathcal{I}k \Delta x} \\
     &\quad-e^{\mathcal{I}k \Delta x}-1+e^{\mathcal{I}(k-l) \Delta x}+e^{-\mathcal{I}l \Delta x} \\ 
     &\quad\left.-1-e^{-\mathcal{I}k \Delta x}+e^{-\mathcal{I}l \Delta x}+e^{-\mathcal{I}(k+l) \Delta x} \right]. 
    \end{split}
\end{equation*}
Simplifying further gives
\begin{equation*}
    \begin{split}
    \left(\lambda - \lambda^{-1}\right)^2 = \mu^2&\left[  -e^{\mathcal{I}k \Delta x}-e^{\mathcal{I}l \Delta x}+e^{-\mathcal{I}k \Delta x}+e^{-\mathcal{I}l \Delta x}-8  \right.\\
    &\quad \left. +2e^{\mathcal{I}(k+l) \Delta x}
     + 2e^{\mathcal{I}(k-l) \Delta x} 
     +2e^{\mathcal{I}(-k+l) \Delta x}  
     +2e^{-\mathcal{I}(k+l) \Delta x} 
     \right]
     \end{split}
